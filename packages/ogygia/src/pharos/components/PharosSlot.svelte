<script lang="ts">
	 ...
	 * `<Ph__Slot tag="a" href="y">x`) into this ONE component; here — at render, in app-land — we
	 * look the tag up in the site's component map and render that component, else the plain element.
	 *
	 * The map holds real component VALUES and lives in `pharos(outline, { components })`, reaching us
