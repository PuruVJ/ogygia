/**
 * freeze — observed purity. The handle patches the event IN PLACE (identity preserved — Kit
 ...
 * observed too) and `Date.now()`/randomness in loads ("true at render time", the prerender/FREEZE
 * contract).
 */
