...
//
//   node verify/bundle-size.ts            # measure + show diff vs snapshot
//   node verify/bundle-size.ts --update   # rewrite the baseline snapshot
//   node verify/bundle-size.ts --json     # machine-readable output (for the docs page)
// ─────────────────────────────────────────────────────────────────────────────
...
if (update) {
	...
	console.log(`✓ baseline snapshot written → verify/bundle-size.snapshot.json`);
}
