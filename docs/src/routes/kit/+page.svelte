...
<main class="shell" style="padding-top: 2.5rem; padding-bottom: 4rem;">
	...
	<p>
		...
		work; Kit hydrates them once as normal components. <code>&lt;OgygiaRouter /&gt;</code> sits in
	...
	<div style="margin-top: 2rem; max-width: 280px;">
		<Counter start={42} label="Kit-page counter" />
	</div>
</main>
