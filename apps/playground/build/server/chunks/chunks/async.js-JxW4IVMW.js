...
var Boundary = class {
	...
	*/
	...
	#hydrate_pending_content() {
		...
		queue_micro_task(() => {
			var partial = this.#offscreen_fragment = document.createDocumentFragment();
			var anchor = create_text();
			partial.append(anchor);
			this.#main_effect = this.#run(() => {
				return branch(() => this.#children(anchor));
			});
			if (this.#pending_count === 0) {
				this.#anchor.before(partial);
	...
	#render() {
		try {
			...
			if (this.#pending_count > 0) {
				var partial = this.#offscreen_fragment = document.createDocumentFragment();
				move_effect(this.#main_effect, partial);
				const pending = this.#props.pending;
				this.#pending_effect = branch(() => pending(this.#anchor));
...
/**
* @param {Effect} effect
* @param {DocumentFragment} partial
*/
function move_effect(effect, partial) {
...
//#endregion
//#region ../node_modules/.pnpm/svelte@5.56.8/node_modules/svelte/src/internal/flags/async.js
enable_async_mode_flag();

export { stringify$1 as $, run as A, noop as B, hasContext as C, getContext as D, getAllContexts as E, getAbortSignal as F, createContext as G, HYDRATION_ERROR as H, lifecycle_function_unavailable as I, ssr_context as J, experimental_async_required as K, LEGACY_PROPS as L, get_render_context as M, hydratable_serialization_failed as N, hydrating as O, push$1 as P, component_context as Q, hydration_mismatch as R, pop$1 as S, writable as T, readable as U, escape_html as V, head as W, attr as X, spread_props as Y, html as Z, ensure_array_like as _, async_mode_flag as a, attributes as a0, get_first_child as b, get_next_sibling as c, define_property as d, set_hydrating as e, flushSync as f, get as g, set_hydrate_node as h, init_operations as i, hydration_failed as j, clear_text_content as k, component_root as l, mutable_source as m, hydrate_node as n, create_text as o, boundary as p, array_from as q, render as r, set as s, is_passive_event as t, set_active_reaction as u, set_active_effect as v, active_reaction as w, active_effect as x, setContext as y, derived as z };
//# sourceMappingURL=async.js-JxW4IVMW.js.map
