...
// islands), so guides can host live components mid-prose — the pharos "dialect" primitive.
export default defineConfig({
	...
	plugins: [
		ogygia({
			...
			// `overrides` wraps a/img/code in the pharos slot; the pharos site's component map (default
