/**
 * kitMount: the SAME cms app mounted from a PLAIN SvelteKit catchall — no ogygia router. The
...
const m = kitMount(cms, { user: () => session() });
