...
#   - or temporarily switch to adapter-node and `ORIGIN=… PORT=3051 node apps/playground/build/index.js`
...
Trust-boundary notes for region HMAC / SPA / seeds live in [`INVARIANTS.md`](../internal/notes/INVARIANTS.md).
