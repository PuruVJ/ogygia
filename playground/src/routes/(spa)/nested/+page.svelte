...
<p data-static-shell>
	Outer is a <code>load</code> island. Its own source imports Inner as a
	<code>visible</code> island. Inner degrades to a normal component and hydrates with Outer —
	one hydration, both interactive.
</p>
